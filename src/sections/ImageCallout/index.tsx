...
export const ImageCallout: React.FunctionComponent<IImageCallout> = ({ title, cta, description, description2, image }) => {
    ...
    return (
        <Section id={title} className={'flex md:pr-0 md:text-center pt-48 pb-40 md:pt-40 md:pb-24'} noPadding>
            ...
            {description2 &&
             <div className="flex-1 w-1/2 mb-12 pb-12 leading-loose text-lg border-b border-darken-50 md:border-none sm:px-2"
